...
app.post("/add-medicine", (req, res) => {
    ...
    const medicineStatus = status || "Pending";
...
app.get("/today-medicines/:user_id", (req, res) => {
    ...
    db.all(sql, [user_id, today], (err, rows) => {
        if (err) {
            console.log("Fetch today medicines error:", err.message);
            return res.json({
                success: false,
...
app.get("/medicine/:id", (req, res) => {
    ...
    db.get(sql, [id], (err, row) => {
        if (err) {
            console.log("Fetch medicine error:", err.message);
            return res.json({
                success: false,
...
app.put("/update-medicine/:id", (req, res) => {
    ...
    db.run(
        ...
        function (err) {
            if (err) {
                console.log("Update medicine error:", err.message);
                return res.json({
                    success: false,
